...
| Walk/kill/pickup/relogin | Partial | world tick/map/collision/movement visibility core is unit tested; 7200 protocol adapter, combat, items and persistence remain |
