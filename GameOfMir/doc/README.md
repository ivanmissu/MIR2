...
本目录存放 MIR2（热血传奇 Delphi 全栈源码）项目的研究与工程文档。
...
- `mir2_development_install.txt` —— 原始 Delphi 6 开发环境安装说明（英文）

## ⚠️ 合规声明

传奇（Legend of Mir）IP 与美术资源版权归盛趣游戏 / Wemade 所有。本项目文档与代码仅限技术学习与私密社区研究，禁止商业运营与客户端资源分发。
